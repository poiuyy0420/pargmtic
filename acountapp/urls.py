...
from acountapp.views import hello_world, AcountCreateView, AcountDeatilView, AcountUpdateView, AcountDeleteView
...
urlpatterns = [
    ...
    path('delete/<int:pk>', AcountDeleteView.as_view(), name='delete'),
